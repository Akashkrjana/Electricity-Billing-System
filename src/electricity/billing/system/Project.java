...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String user, String meter) {
        ...
        JMenuItem newcoustomer = new JMenuItem("New Customer");
        newcoustomer.setFont(new Font("Monospaced", Font.PLAIN, 12));
        newcoustomer.setBackground(Color.WHITE);
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/icon1.png"));
        Image image1 = icon1.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        newcoustomer.setIcon(new ImageIcon(image1));
        newcoustomer.setMnemonic('D');
        newcoustomer.addActionListener(this);
        newcoustomer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
        master.add(newcoustomer);
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/icon5.png"));
        ...
        userinfo.add(billdetails);

        JMenu report = new JMenu("Monthly Report");
